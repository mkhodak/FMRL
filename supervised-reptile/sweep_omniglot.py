...
def main():
    ...
    train_set, val_set = train_set[:-200], train_set[-200:]
    ...
    with tf.Session() as sess:
        ...
        if not args.pretrained:
            print('Training...')
            train(sess, model, train_set, val_set, args.checkpoint, eval_kwargs=eval_kwargs, **train_kwargs(args))
        else:
        ...
        print('Valid accuracy: ' + str(evaluate(sess, model, val_set, **eval_kwargs)))
